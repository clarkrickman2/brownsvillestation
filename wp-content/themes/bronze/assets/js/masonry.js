	...
	return {
		...
		infiniteScroll : function () {
			...
			$container.infinitescroll( {
				...
				loading: {
					finishedMsg: BronzeParams.l10n.infiniteScrollEndMsg,
					msgText : BronzeParams.l10n.infiniteScrollMsg,
					img: BronzeParams.infiniteScrollGif,
