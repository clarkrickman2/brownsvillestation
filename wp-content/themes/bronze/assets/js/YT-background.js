		...
		init : function ( $container ) {
			...
			setTimeout( function() {
				...
				if ( typeof window.onYouTubePlayerAPIReady !== 'undefined' ) {
					if ( typeof window.BronzeOtherYTAPIReady === 'undefined' ) {
						window.BronzeOtherYTAPIReady = [];
					}
					window.BronzeOtherYTAPIReady.push( window.onYouTubePlayerAPIReady );
				}
				...
				window.onYouTubePlayerAPIReady = function() {
					...
					if ( typeof window.BronzeOtherYTAPIReady !== 'undefined' ) {
						if ( window.BronzeOtherYTAPIReady.length ) {
							window.BronzeOtherYTAPIReady.pop()();
						}
					}
				};
			}, 2 );
