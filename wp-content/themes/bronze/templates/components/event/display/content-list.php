...
<li <?php bronze_post_attr(); ?>>
	...
	<span class="event-table-cell event-venue" itemprop="location" itemscope itemtype="https://schema.org/<?php echo esc_attr( apply_filters( 'bronze_microdata_event_itemtype_venue', 'MusicVenue' ) ); ?>">
		<?php if ( $do_link ) : ?>
			<a rel="bookmark" class="event-link-mask" href="<?php the_permalink(); ?>"></a>
		<?php endif; ?>
