	...
	<div class="author-box clearfix">
		<div class="author-avatar">
			<a itemprop="url" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
				<?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'bronze_author_box_avatar_size', 80 ) ); ?>
			</a>
		</div><!-- .author-avatar -->
		<div class="author-description" itemprop="author" itemscope itemtype="https://schema.org/Person">
			...
			<p>
				<a itemprop="url" class="author-page-link <?php echo esc_attr( apply_filters( 'bronze_author_page_link_button_class', 'button-secondary' ) ); ?>" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
					<?php printf( esc_html__( 'View all posts by %s', 'bronze' ), get_the_author() ); ?>
				</a>
			</p>
