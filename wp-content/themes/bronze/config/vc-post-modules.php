		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'bronze_post_display_options', array(
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'bronze_product_display_options', array(
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'bronze_work_display_options', array(
				...
				array(
					...
					'value' => array(
						...
						//esc_html__( 'Flip Box', 'bronze' ) => 'flip-box',
					),
					'admin_label' => true,
					'dependency' => array(
						'element' => 'work_display',
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'bronze_release_display_options', array(
						'grid' => esc_html__( 'Grid', 'bronze' ),
					) ) ),
					'admin_label' => true,
				),
				...
				// array(
				// 	'type' => 'dropdown',
				// 	'heading' => esc_html__( 'Text Alignment', 'bronze' ),
				...
				// array(
				// 	'type' => 'dropdown',
				// 	'heading' => esc_html__( 'Text Vertical Alignment', 'bronze' ),
				...
				array(
					'type' => 'wvc_textfield',
					'heading' => esc_html__( 'Include Label', 'bronze' ),
					'param_name' => 'label_include',
					'description' => esc_html__( 'Enter one or several labels. Paste category slug(s) separated by a comma', 'bronze' ),
					'placeholder' => esc_html__( 'my-category, other-category', 'bronze' ),
					'group' => esc_html__( 'Query', 'bronze' ),
				),
				...
				array(
					'type' => 'wvc_textfield',
					'heading' => esc_html__( 'Exclude Label', 'bronze' ),
...
if ( class_exists( 'Wolf_Albums' ) ) {
	$gallery_display_options = ( function_exists( 'bronze_get_gallery_display_options' ) ) ? bronze_get_gallery_display_options() : array();
/**
 * Albums Loop Module
 */
vc_map(
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'bronze_gallery_display_options', array(
						'grid' => esc_html__( 'Grid', 'bronze' ),
					) ) ),
					'admin_label' => true,
				),
				...
				array(
					...
					'admin_label' => true,
					'dependency' => array( 'element' => 'gallery_display', 'value' => array( 'grid' ) ),
				),
				...
				array(
					...
					'param_name' => 'caption_text_aligntment',
					'type' => 'dropdown',
					'value' => array(
						esc_html__( 'Center', 'bronze' ) => 'center',
						esc_html__( 'Left', 'bronze' ) => 'left',
				...
				array(
					...
					'description' => esc_html__( 'Select an overlay color.', 'bronze' ),
					'param_holder_class' => 'wvc_colored-dropdown',
					'dependency' => array( 'element' => 'gallery_layout', 'value' => array( 'overlay' ) ),
				),
				...
				array(
					...
					'type' => 'checkbox',
					'admin_label' => true,
					//'dependency' => array( 'element' => 'gallery_module', 'value' => array( 'grid' ) ),
				),
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array(
						esc_html__( 'Default', 'bronze' ) => 'default',
						esc_html__( 'Two', 'bronze' ) => 2,
						esc_html__( 'Three', 'bronze' ) => 3,
						esc_html__( 'Four', 'bronze' ) => 4,
						esc_html__( 'Five', 'bronze' ) => 5,
...
class WPBakeryShortCode_Wvc_Gallery_Index extends WPBakeryShortCode {}
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'bronze_event_display_options', array(
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'bronze_artist_display_options', array(
						'list' => esc_html__( 'List', 'bronze' ),
					) ) ),
					'admin_label' => true,
				),
				...
				array(
					...
					'admin_label' => true,
					//'dependency' => array( 'element' => 'artist_layout', 'value' => array( 'overlay', 'flip-box' ) ),
				),
...
class WPBakeryShortCode_Wvc_Artist_Index extends WPBakeryShortCode {}
