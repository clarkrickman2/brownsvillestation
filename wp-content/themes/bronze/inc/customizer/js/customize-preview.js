...
;( function( $ ) {
	 ...
	 * Background
	 */
	var colorSchemeStyle = $( '#bronze-color-scheme-css' ),
		fontsStyle = $( '#bronze-fonts-css' ),
		layoutStyle = $( '#bronze-layout-css' ),
		api = wp.customize,
		backgrounds = {
	...
	if ( ! colorSchemeStyle.length ) {
		colorSchemeStyle = $( 'head' ).append( '<style type="text/css" id="bronze-color-scheme-css" />' )
			.find( '#bronze-color-scheme-css' );
	}

	// Fonts style tag
	if ( ! fontsStyle.length ) {
		fontsStyle = $( 'head' ).append( '<style type="text/css" id="bronze-fonts-css" />' )
			.find( '#bronze-fonts-css' );
	}

	// Layout style tag
	if ( ! layoutStyle.length ) {
		layoutStyle = $( 'head' ).append( '<style type="text/css" id="bronze-layout-css" />' )
			.find( '#bronze-layout-css' );
	}
	...
	api( 'menu_width', function( value ) {
		value.bind( function( to ) {
			...
			BronzeUi.centeredLogoOffset();
			BronzeUi.subMenuDirection();
		} );
	} );
	...
	api( 'footer_type', function( value ) {
		value.bind( function( to ) {
			...
			BronzeUi.footerPageMarginBottom();
		} );
	} );
