 ...
 */
function bronze_dequeue_plugin_styles() {
...
add_action( 'wp_enqueue_scripts', 'bronze_dequeue_plugin_styles' );

if ( ! function_exists( 'bronze_enqueue_styles' ) ) {
	/**
	 * Enqueue CSS stylsheets
	 * JS scripts are separated and can be found in inc/scripts.php
	 */
	function bronze_enqueue_styles() {
		...
		* Register Icon files
		*/
		wp_register_style( 'font-awesome', get_template_directory_uri() . '/assets/css/lib/fonts/fontawesome/font-awesome.min.css', array(), bronze_get_theme_version() );
		wp_register_style( 'socicon', get_template_directory_uri() . '/assets/css/lib/fonts/socicon/socicon.min.css', array(), bronze_get_theme_version() );

		wp_register_style( 'linea-icons', get_template_directory_uri() . '/assets/css/lib/fonts/linea-icons/linea-icons.min.css', array(), bronze_get_theme_version() );

		wp_register_style( 'linearicons', get_template_directory_uri() . '/assets/css/lib/fonts/linearicons/linearicons.min.css', array(), bronze_get_theme_version() );
		...
		*/
		...
		$version = ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ? time() : bronze_get_theme_version();
		wp_enqueue_style( 'bronze-style', get_template_directory_uri() . '/assets/css/main' . $suffix . '.css', array(), $version );
		wp_enqueue_style( 'bronze-single-post-style', get_template_directory_uri() . '/assets/css/single-post.css', array(), $version );
		wp_enqueue_style( 'bronze-default', get_stylesheet_uri(), array(), bronze_get_theme_version() );
	}
	add_action( 'wp_enqueue_scripts', 'bronze_enqueue_styles' );
}
